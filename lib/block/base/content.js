...
class Content extends TreeNode {
  ...
  listenDOMEvents () {
    ...
    const eventIds = [
      eventCenter.attachDOMEvent(domNode, 'input', this.inputHandler),
      eventCenter.attachDOMEvent(domNode, 'keydown', this.keydownHandler),
      eventCenter.attachDOMEvent(domNode, 'keyup', this.keyupHandler),
      eventCenter.attachDOMEvent(domNode, 'click', this.clickHandler),
      eventCenter.attachDOMEvent(domNode, 'blur', this.blurHandler),
      eventCenter.attachDOMEvent(domNode, 'compositionend', this.composeHandler),
      eventCenter.attachDOMEvent(domNode, 'compositionstart', this.composeHandler)
    ]
