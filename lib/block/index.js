...
import TableHead from '@/block/gfm/table/thead'
import TableBody from '@/block/gfm/table/tbody'
import TableRow from '@/block/gfm/table/row'
import BodyCell from '@/block/gfm/table/bodyCell'
import HeadCell from '@/block/gfm/table/headCell'
// container block
...
ScrollPage.register(TableHead)
ScrollPage.register(TableBody)
ScrollPage.register(TableRow)
ScrollPage.register(BodyCell)
ScrollPage.register(HeadCell)
